...
- On parikin konferenssia, yksi missä Kaltiala oli paikalla briteissä ja vastasi, "no mitä vaikka olisikin?", kun kysyttiin, onko hän SEGM:in jäsen. Toinen oli Bhutanissa, missä ei tarvinnut suojautua epämääräisen "kasvurauha" käsitteen alle, ja osallistujiin kuului Kanadan eheytyshoitokiellon jälkeen klinikkansa menettänyt Zucker.
